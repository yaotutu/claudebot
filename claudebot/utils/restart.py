...
RESTART_NOTIFY_CHANNEL_ENV = env_name("RESTART_NOTIFY_CHANNEL")
RESTART_NOTIFY_CHAT_ID_ENV = env_name("RESTART_NOTIFY_CHAT_ID")
RESTART_NOTIFY_METADATA_ENV = env_name("RESTART_NOTIFY_METADATA")
RESTART_STARTED_AT_ENV = env_name("RESTART_STARTED_AT")

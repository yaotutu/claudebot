...
from claudebot.utils.path import abbreviate_path
...
_LEGACY_MODULE_ALIASES = {
    "webui_thread_disk": "claudebot.webui.thread_disk",
    "webui_transcript": "claudebot.webui.transcript",
    "webui_turn_helpers": "claudebot.session.webui_turns",
}

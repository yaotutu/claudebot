...
Persistent storage at ``~/.claudebot/pairing.json`` keeps approved senders
...
from claudebot.config.paths import get_data_dir
from claudebot.utils.helpers import _write_text_atomic

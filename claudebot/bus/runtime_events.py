...
This bus is separate from :mod:`claudebot.bus.queue`: message bus events are
...
from claudebot.bus.events import InboundMessage
...
class RuntimeModelChanged:
    """The active runtime model changed."""
...
class RuntimeEventPublisher:
    ...
    def runtime_model_changed(self, model: str) -> None:
        self.bus.publish_nowait(RuntimeModelChanged(model=model))

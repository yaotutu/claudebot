...
from claudebot.command.builtin import builtin_command_palette
from claudebot.utils.subagent_channel_display import scrub_subagent_messages_for_channel
from claudebot.webui.file_preview import WebUIFilePreviewError, file_preview_payload
from claudebot.webui.gateway_tokens import GatewayTokenStore, token_response_payload
...
from claudebot.webui.session_automations import session_automations_payload
from claudebot.webui.sidebar_state import (
    read_webui_sidebar_state,
    write_webui_sidebar_state,
)
from claudebot.webui.skills_api import webui_skill_detail_payload, webui_skills_payload
from claudebot.webui.thread_disk import delete_webui_thread
from claudebot.webui.transcript import build_webui_thread_response
...
def _default_model_name_from_config() -> str | None:
    try:
        ...
        model = load_config().claude_code.model.strip()
...
class GatewayHTTPHandler:
    ...
    def __init__(
        ...
        *,
        ...
        from claudebot.webui.settings_routes import WebUISettingsRouter
    ...
    def _handle_session_automations(self, request: WsRequest, key: str) -> Response:
        ...
        if not _is_websocket_channel_session_key(decoded_key):
            return _http_error(404, "session not found")
        return _http_json_response(session_automations_payload(self.cron_service, decoded_key))

...
from claudebot.security.workspace_access import WorkspaceScope
from claudebot.security.workspace_policy import WorkspaceBoundaryError, resolve_allowed_path

...
This directory contains built-in skills that extend claudebot's capabilities.
...
When skills reference large local documentation or logs, prefer claudebot's built-in

...
import type { CliAppInfo, McpPresetInfo, ToolProgressEvent, UIMessage } from "@/lib/types";
...
describe("AgentActivityCluster", () => {
  it("renders Claude Code tool activity as readable timeline rows", () => {
    const toolEvents = [
      {
        phase: "start",
        name: "claude_tool_start",
        arguments: {
      ...
      },
      {
        ...
        arguments: {
          kind: "claude_tool_start",
          toolName: "Bash",
          input: { command: "pytest tests/claude_code -v" },
          toolUseId: "tool-2",
        },
      },
    ...
    render(
      <AgentActivityCluster
        messages={[{
          ...
          kind: "trace",
          content: "",
          traces: toolTraceLinesFromEvents(toolEvents),
          toolEvents,
          createdAt: 1,
        }]}
        isTurnStreaming
    ...
    expect(screen.getByText('name = "claudebot"')).toBeInTheDocument();
    expect(screen.getByText("Bash")).toBeInTheDocument();
    expect(screen.getByText("pytest tests/claude_code -v")).toBeInTheDocument();
  });
  ...
  it("renders file edit totals and a compact expanded file list", async () => {
    ...
    try {
        ...
        <AgentActivityCluster
          messages={activityMessages("", {
            ...
            fileEdits: [{
              ...
              tool: "edit_file",
              path: "src/app.tsx",
              absolute_path: "/Users/example/project/src/app.tsx",
              phase: "end",
              added: 12,
              deleted: 3,
              approximate: false,
      ...
      expect(fileRef).toHaveAttribute("aria-label", "/Users/example/project/src/app.tsx");
        ...
        messages={[
          {
            ...
            role: "tool",
            kind: "trace",
            content: 'web_search({"query":"claudebot architecture"})',
            traces: ['web_search({"query":"claudebot architecture"})'],
            createdAt: 1,
          },
          {
            id: "t-cli",
      ...
      <AgentActivityCluster
        messages={activityMessages("", {
          ...
          fileEdits: [{
            call_id: "call-write",
            tool: "write_file",
            path: "/Users/example/.claudebot/workspace/agent-research-video/composition.html",
            phase: "error",
            added: 0,
            deleted: 0,
            approximate: false,
            status: "error",
            error: "Error writing file: [Errno 13] Permission denied: '/Users/example'",
          }],
          createdAt: 3,
        })}
        isTurnStreaming={false}

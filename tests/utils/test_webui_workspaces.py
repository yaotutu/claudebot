...
from claudebot.security.workspace_access import default_workspace_scope
...
def test_workspace_state_defaults_when_file_missing(tmp_path, monkeypatch) -> None:
    monkeypatch.setattr("claudebot.webui.workspaces.get_webui_dir", lambda: tmp_path / "webui")

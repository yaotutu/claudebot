"""Lightweight WebSocket test client for integration testing the claudebot WebSocket channel.
...
integration tests can import and use directly::
    ...
    async with WsTestClient("ws://127.0.0.1:18790/", client_id="t") as c:
...
class WsTestClient:
    ...
    Usage::
        ...
        async with WsTestClient("ws://127.0.0.1:18790/", client_id="tester") as client:

...
from claudebot.cli.stream import StreamRenderer, ThinkingSpinner
from claudebot.config.schema import AgentDefaults, Config


def test_bot_name_and_icon_defaults_preserve_current_branding() -> None:
    """Default values keep the existing 'claudebot' name and cat icon."""
    defaults = AgentDefaults()

    assert defaults.bot_name == "claudebot"

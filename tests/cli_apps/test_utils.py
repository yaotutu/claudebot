...
from claudebot.apps.cli.service import CliAppManager
from claudebot.apps.cli.utils import runtime_lines, session_extra
...
def test_cli_app_mentions_inject_runtime_metadata(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("claudebot.apps.cli.service.get_runtime_subdir", lambda _name: data_dir)
